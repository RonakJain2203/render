...
df = pd.read_csv('D:/GLIM/Term5/Predictivie Aalytics Lab 2/P1/Proj1_LocalHost/files_for_training_model/heart_data.csv')
print(df.head())
...
print("Possibility of heart disease is =",model.predict([[20.1, 56.3]]))
...
print("Coefficients of regressions are ....")
